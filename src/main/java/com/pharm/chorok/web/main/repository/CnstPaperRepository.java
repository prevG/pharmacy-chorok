...
public interface CnstPaperRepository {
	 ...
	 * 
	 * public List<TbSurveyQuest> selectSurveyQuestList(TbSurvey tbSurvey) throws
	 * Exception;
	 * 
	 * public List<TbSurveyExam> selectSurveyExamList(TbSurvey tbSurvey) throws
	 * Exception;
	 * 
	 * public List<TbSurveyAnsExam> selectTbSurveyAnsExamList(TbSurvey tbSurvey)
	 * throws Exception;
	 */
	
	
	public List<TbPpCnstPaper> selectCnstPaperList(TbPpCnstPaper tbPpCnstPaper) throws Exception;
